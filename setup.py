# -*- coding: utf-8 -*-
"""Setup for falcon-provider-audit package."""
# standard library
import os
...
metadata_file = os.path.join(
    os.path.abspath(os.path.dirname(__file__)), 'falcon_provider_audit', '__metadata__.py'
)
...
setup(
    ...
    package_dir={'falcon_provider_audit': 'falcon_provider_audit'},
    project_urls={
        'Documentation': 'https://github.com/bcsummers/falcon-provider-audit/',
        'Source': 'https://github.com/bcsummers/falcon-provider-audit/',
    },
    python_requires='>=3.6',
    scripts=[],
    test_suite='tests',
